...
static const struct of_device_id my_of_ids[] = {    //用于与设备树节点匹配
    { .compatible = "arrow,hellokeys"},
    {},
};
MODULE_DEVICE_TABLE(of, my_of_ids); //导出
...
static struct platform_driver my_platform_driver = {
    ...
    .driver = {
    .name = "hellokeys",
    .of_match_table = my_of_ids,    //该platform_driver与该of_match_table绑定
    .owner = THIS_MODULE,
    }
};
/* Register your platform driver */
module_platform_driver(my_platform_driver); //注册platform_driver
